package org.pzone.crypto.sm4;

import java.util.Arrays;

import org.pzone.crypto.Tools;
...
public class SMS4 {
	...
	public static void main(String[] args) {
		...
		byte[] keyByte = Tools.hexStringToBytes(key);
		String input = "0123456789ABCDEFFEDCBA9876543210";
		byte[] inputBytes = Tools.hexStringToBytes(input);
		byte[] enOut = SMS4.encodeSMS4(inputBytes,keyByte);
		System.out.println("加密结果：");
		System.out.println(toHexString(enOut));
		
		byte[] decodeSMS4 = SMS4.decodeSMS4(enOut, keyByte);
		System.out.println(toHexString(decodeSMS4));
		System.out.println(new String(decodeSMS4));
	}
}
